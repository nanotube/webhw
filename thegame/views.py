...
def create_account(request, template_name):
    ...
    if request.method == 'POST': # If the form has been submitted...
        ...
        if form.is_valid():
            ...
            new_membership = Membership(user = new_userprofile, world = world, approved=False)
            new_membership.save()
...
def user_profile(request):
    ...
    return render_to_response('userprofile.html', {'user_membership_list':user_membership_list,}, context_instance=RequestContext(request))
